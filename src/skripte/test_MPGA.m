...
fit4_1 = FitnessFactory.get_car_location_punishing([0; 0], [0; 1], true, 0);
fit4_2 = FitnessFactory.get_car_location_punishing([0; 0], [0; 1], false, 0);
...
test.runMPGA(0, 20, 5, 'ring'); % führt MPGA durch  mit MigrationRate 1, Migration interval - 3 Epochen, Anzahl Migrationsvorgänge 2
